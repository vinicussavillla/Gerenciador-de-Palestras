    ...
    <div class="col-lg-6">
        <div class="form-group">
            ...
            <input
                ...
                id="name"
                name="name"
                value="{{ old('name', isset($palestra) ? $palestra->name : '') }}"
            >
    ...
    <div class="col-lg-6">
        <div class="form-group">
            ...
            <input
                ...
                value="{{ old('name_palestrante', isset($palestra) ? $palestra->name_palestrante : '') }}"
            >
    ...
    <div class="col-lg-3">
        <div class="form-group">
            ...
            <input
                ...
                value="{{ old('inicio_data_palestra', isset($palestra) ? $palestra->inicio_data_palestra : '') }}"
    ...
    <div class="col-lg-3">
        <div class="form-group">
            ...
            <input
                ...
                value="{{ old('final_data_palestra', isset($palestra) ? $palestra->final_data_palestra : '') }}"
                data-mask="00/00/0000 00:00"
            >
    ...
    <div class="col-lg-3">
        <div class="form-group">
            ...
            <input
                ...
                min="1"
                value="{{ old('limite_participantes', isset($palestra) ? $palestra->limite_participantes : '') }}"
            >
    ...
    <div class="col-12">
        <div class="form-group">
            ...
            <textarea
                ...
                name="publico_alvo"
                rows="3"
            >{{ old('publico_alvo', isset($palestra) ? $palestra->publico_alvo : '') }}</textarea>
